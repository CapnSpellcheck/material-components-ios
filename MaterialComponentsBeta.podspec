Pod::Spec.new do |mdc|
  ...
  mdc.subspec "BottomNavigation" do |component|
    ...
    component.source_files = "components/#{component.base_name}/src/MDCBottomNavigationBarController.*", "components/#{component.base_name}/src/MDCBottomNavigationBarControllerDelegate.*", "components/#{component.base_name}/src/MaterialBottomNavigationBeta.h"
